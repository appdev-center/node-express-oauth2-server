...
var InvalidArgumentError = require('adc-node-oauth2-server/lib/errors/invalid-argument-error');
var NodeOAuthServer = require('adc-node-oauth2-server');
var Promise = require('bluebird');
var Request = require('adc-node-oauth2-server').Request;
var Response = require('adc-node-oauth2-server').Response;
var UnauthorizedRequestError = require('adc-node-oauth2-server/lib/errors/unauthorized-request-error');
